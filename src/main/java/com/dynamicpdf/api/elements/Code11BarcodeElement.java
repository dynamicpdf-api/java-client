 ...
 * 
 * <p> This class can be used to place a Code 11 barcode on a page.</p>
 */
...
public class Code11BarcodeElement extends TextBarcodeElement {
	...
	/**
	 * Initializes a new instance of the <code>Code11BarcodeElement</code> class
	 * 
	 ...
	 * @param yOffset The Y coordinate of the barcode.
	 */
	public Code11BarcodeElement(String value, float height, float xOffset, float yOffset) {
	 ...
	 * @param height The height of the barcode.
	 */
	public Code11BarcodeElement(String value, float height) {
