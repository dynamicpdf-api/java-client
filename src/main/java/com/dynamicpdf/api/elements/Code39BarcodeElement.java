 ...
 * 
 * <p> This class can be used to place a Code 3 of 9 barcode on a page.</p>
 */
...
public class Code39BarcodeElement extends TextBarcodeElement {
	...
	/**
	 * Initializes a new instance of the <code>Code39BarcodeElement</code> class
	 * 
	 ...
	 * @param yOffset The Y coordinate of the barcode.
	 */
	public Code39BarcodeElement(String value, float height, float xOffset, float yOffset) {
	 ...
	 * @param height The height of the barcode.
	 */
	public Code39BarcodeElement(String value, float height) {
